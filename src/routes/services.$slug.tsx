      ...
      <main className="pt-36 pb-20">
        ...
        <section className="px-6 md:px-10 mb-16 overflow-hidden">
          <div className="max-w-[1400px] mx-auto text-center">
            ...
            <div ref={heroRef} className="relative w-full h-[65vh] rounded-2xl overflow-hidden shadow-[0_40px_100px_-20px_rgba(0,0,0,0.5)] perspective-1000 border border-white/5">
          ...
          <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-24 items-start">
             <Reveal className="space-y-12">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <div className="text-[10px] uppercase tracking-[0.3em] font-bold text-red-600">Premium Standards</div>
                </div>
             </Reveal>
               ...
               <div className="grid grid-cols-2 gap-x-12 gap-y-16">
                 {service.stats.map((stat, i) => (
                   <Reveal key={i} delay={0.3 + i * 0.1}>
                     <div className="group border-l-4 border-red-600 pl-8 hover:pl-10 transition-all duration-500">
                       <div className="text-5xl font-display text-red-grad mb-3"><Counter value={stat.value} /></div>
                       <div className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground font-bold group-hover:text-red-600 transition-colors">{stat.label}</div>
                     </div>
                   </Reveal>
                 ))}
               </div>
               ...
               {service.highlights.map((h, i) => (
                 <Reveal key={i} delay={i * 0.1}>
                   <Card3D className="h-full">
                     <div className="bg-surface/50 p-12 h-full shadow-2xl rounded-2xl border border-white/5 hover:border-red-600/30 transition-all duration-700 group">
                        <div className="text-red-600 font-bold mb-8 text-2xl opacity-40 group-hover:opacity-100 transition-opacity">0{i+1}.</div>
        ...
        {/* Contact */}
        <section className="px-6 md:px-10 py-32 border-t border-white/5 bg-background relative overflow-hidden">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-px h-32 bg-gradient-to-b from-red-600 to-transparent" />
          ...
          <div className="max-w-[1400px] mx-auto text-center">
             ...
             <div className="max-w-2xl mx-auto space-y-4">
               ...
               <Reveal delay={0.3} width="100%">
                 <div className="text-red-600 uppercase tracking-[0.4em] text-xs font-bold mb-12">{service.contact.role}</div>
               </Reveal>
               
               <div className="flex flex-col md:flex-row justify-center gap-12 pt-12 border-t border-white/5">
                 <Reveal delay={0.4}>
                   <a href={`mailto:${service.contact.email}`} className="group flex items-center justify-center gap-4 text-xl text-foreground/80 hover:text-red-600 transition-all">
                     <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:border-red-600 group-hover:bg-red-600/5 transition-all">
                        <Mail size={20} />
                     </div>
                 ...
                 <Reveal delay={0.5}>
                   <a href={`tel:${service.contact.phone}`} className="group flex items-center justify-center gap-4 text-xl text-foreground/80 hover:text-red-600 transition-all">
                     <div className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center group-hover:border-red-600 group-hover:bg-red-600/5 transition-all">
                        <Phone size={20} />
                     </div>
